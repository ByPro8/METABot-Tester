...
META_TEMPLATES_DIR = BASE_DIR / "meta_templates" / "denizbank"
DEFAULT_TEMPLATE_ID = "DENIZBANK_MAIN_V1"

ALLOWED_TEMPLATE_IDS = ["DENIZBANK_MAIN_V1"]
...
def run_template_check(
    ...
    if template_id not in ALLOWED_TEMPLATE_IDS:
        raise ValueError(f"Template id not supported by denizbank engine: {template_id}")
